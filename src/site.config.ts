...
const config: SiteConfig = {
  ...
  site: 'https://cutemc.cn',
  // The name of your site, used in the title and for SEO.
  title: "Zara's Blog",
  // The description of your site, used for SEO and RSS feed.
  description:
    'A cute blog about cute things, coding, and life.',
  // The author of the site, used in the footer, SEO, and RSS feed.
  author: 'Zara Lee',
  // Keywords for SEO, used in the meta tags.
  tags: ['Vue', 'Coding', 'Java', 'Minecraft', 'Blog', 'Tech', 'Programming', 'Tailwind CSS'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/lushangkan',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/lushangkan',
    email: 'emailto:lushangkanjian@gmail.com',
    twitter: 'https://twitter.com/lushangkan',
  ...
  giscus: {
    repo: 'lushangkan/my-blog',
    repoId: 'R_kgDOQTXoug',
    category: 'Giscus',
    categoryId: 'DIC_kwDOQTXous4Cxq0C',
